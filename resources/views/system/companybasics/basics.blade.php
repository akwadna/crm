@extends('layouts.app', ['activePage' => 'basics', 'titlePage' => __('بيانات أساسية')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2">
                    <button class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="material-icons mdc-button__icon">add_circle_outline</i>أضف تقرير<div class="ripple-container"></div></button>
                            ...
                            <div class="modal-content">
                                <div class="card card-signup card-plain">
                                    <div class="modal-header">
                                        <h5 class="modal-title card-title">بيانات أساسية</h5>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">كل التقارير</h4>
                        </div>
                        <div class="card-body">
