                        ...
                        <div class="card-header card-header-primary">
                            ...
                            <div class="row">
                                <div class="col-md-6 align-self-center">
                                    <h4 class="card-title ">بيانات المورد: {{$vendor->vendor_name}}</h4>
                                    <div class="card-category">الموظف المسؤل: {{$user->name}}</div>
                                </div>
                                <div class="col-md-3 text-left">
                                    <form method="get" action="/vendors/{{$vendor->id}}/edit">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th>تاريخ الميلاد</th>
                                                    <td>{{$vendor->vendor_birthDate}}</td>
                                                </tr>
                                                <tr>
                                                    <th>الحساب البنكى</th>
                                                    <td>{{$vendor->vendor_bankAccountNumber}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
