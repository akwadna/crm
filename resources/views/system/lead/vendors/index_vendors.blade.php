...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2">
                    <button class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="material-icons mdc-button__icon">add_circle_outline</i>أضف مورد<div class="ripple-container"></div></button>
                            ...
                            <div class="modal-content">
                                <div class="card card-signup card-plain">
                                    <div class="modal-header">
                                        <h5 class="modal-title card-title">بيانات المورد</h5>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <select id="inputState" class="form-control">
                                                                <option selected>نوع المورد</option>
                                                                <option >تاجر</option>
                                                                <option >مورد</option>
                                                                <option>مؤسسى</option>
                                                            </select>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="date" class="form-control" placeholder="تاريخ الميلاد" id="birthDate">                                                        </div>
                                                        <div class="form-group col-md-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">كل الموردين</h4>
                        </div>
                        <div class="card-body">
