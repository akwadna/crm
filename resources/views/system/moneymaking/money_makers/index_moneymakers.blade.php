...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2">
                    <button class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="material-icons mdc-button__icon">add_circle_outline</i>أضف مرابح<div class="ripple-container"></div></button>
                            ...
                            <div class="modal-content">
                                <div class="card card-signup card-plain">
                                    <div class="modal-header">
                                        <h5 class="modal-title card-title">بيانات المرابح</h5>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <select id="inputState" class="form-control">
                                                                <option selected>نوع المرابحة</option>
                                                                <option >تاجر</option>
                                                                <option >مورد</option>
                                                                <option>مؤسسى</option>
                                                            </select>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <input type="text" class="form-control" placeholder="وظيفة المرابح">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <input type="text" class="form-control" placeholder="رقم التليفون">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <input type="email" class="form-control" placeholder="مبلغ المرابحة">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <select id="inputState" class="form-control">
                                                                <option selected>حالة المرابحة</option>
                                                                <option >تاجر</option>
                                                                <option >مورد</option>
                                                                <option>مؤسسى</option>
                                                            </select>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="date" class="form-control" placeholder="تاريخ الميلاد" id="birthDate">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                                ...
                                                                <div>
                                                                    <span class="btn btn-raised btn-round btn-default btn-file">
                                                                        <span class="fileinput-new">اخر الصورة</span>
                                                                        <span class="fileinput-exists">تغيير</span>
