                        ...
                        <div class="card-header card-header-primary">
                            ...
                            <div class="row">
                                <div class="col-md-6 align-self-center">
                                    <h4 class="card-title ">بيانات المرابح: {{$money_maker->money_maker_name}}</h4>
                                    <div class="card-category">الموظف المسؤل: {{$user->name}}</div>
                                </div>
                                <div class="col-md-3 text-left">
                                    <form method="get" action="/moneymakers/{{$money_maker->id}}/edit">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th>الاسم</th>
                                                    <td>{{$money_maker->money_maker_name}}</td>
                                                </tr>
                                                <tr>
                                                    <th>الوظيفة</th>
                                                    <td>{{$money_maker->money_maker_job}}</td>
                                                </tr>
                                                <tr>
                                                    <th>نوع المرابح</th>
                                                    <td>{{$money_maker->money_maker_processType}}</td>
                                                </tr>
                                                <tr>
                                                    <th>قيمة المرابحة</th>
                                                    <td>{{$money_maker->money_maker_mount}}</td>
                                                </tr>
                                                <tr>
                                                    <th>تاريخ المرابحة</th>
                                                    <td>{{$money_maker->money_maker_payDate}}</td>
                                                </tr>
                                                <tr>
                                                    <th>تاريخ الميلاد</th>
                                                    <td>{{$money_maker->money_maker_birthDate}}</td>
                                                </tr>
                                                <tr>
                                                    <th>صورة البطاقة من الامام</th>
                                                    <td><img src="{{asset('storage')}}/moneymakers/NidPics/{{$money_maker->money_maker_idPicFront}}" width="200px" height="100px"/></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-md-6">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th>الرقم القومى</th>
                                                    <td>{{$money_maker->money_maker_nid}}</td>
                                                </tr>
                                                <tr>
                                                    <th>رقم التليفون</th>
                                                    <td>{{$money_maker->money_maker_phone}}</td>
                                                </tr>
                                                <tr>
                                                    <th>حالة عملية المرابحة</th>
                                                    <td>{{$money_maker->money_maker_processStatus}}</td>
                                                </tr>
                                                <tr>
                                                    <th>البريد الالكترونى</th>
                                                    <td>{{$money_maker->money_maker_email}}</td>
                                                </tr>

                                                <tr>
                                                    <th>الحساب البنكى</th>
                                                    <td>{{$money_maker->money_maker_bankAccountNumber}}</td>
                                                </tr>
                                                <tr>
                                                    <th>صورة البطاقة من الخلف</th>
                                                    <td><img src="{{asset('storage')}}/moneymakers/NidPics/{{$money_maker->money_maker_idPicBack}}" width="200px" height="100px"/></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="col-md-12">
                                            <table>
                                                ...
                                                <tr>
                                                    <th>العنوان</th>
                                                    <td>{{$money_maker->money_maker_address}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <table>
                                                ...
                                                <tr>
                                                    <th>ملاحظات</th>
                                                    <td>{{$money_maker->money_maker_notes}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
